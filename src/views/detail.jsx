...
export default () => {
	...
	function get({ page, anime }) {
		window.scrollTo(0, 0);
		return axios.get('https://katanime.vercel.app/api/getbyanime', {
			params: {
				anime: anime,
				page: page,
			},
	...
	const anime = createMemo(() => params.anime.replace(/-/gi, ' '));
	...
	return (
		<>
			<div className="text-center mb-4 text-2xl font-semibold uppercase">
				{anime()} - Halaman {searchParams.page}
			</div>
